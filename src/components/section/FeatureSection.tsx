            ...
            <div className="w-full md:w-1/2 md:pl-8">
              ...
              >
                <div className="absolute -top-12 left-0">
                  <span className="text-6xl font-light text-gray-300 tracking-tighter">
                    01
                  </span>
                </div>
                <div className="pt-12">
                  ...
                  <p className="text-gray-600 text-lg">
                    짧은 세계관만으로도 충분히 흥미로운 이야기를 시작할 수
                    있어요.
                  </p>
                </div>
              </motion.div>
            ...
            <div className="w-full md:w-1/2 md:pr-8">
              ...
              >
                ...
                <div className="pt-12">
                  ...
                  <p className="text-gray-600 text-lg">
                    매번 다른 이야기를 경험하세요. 동일한 설정에서도 새로운
                    이야기가 탄생합니다.
                  </p>
                </div>
              </motion.div>
            ...
            <div className="w-full md:w-1/2 md:pl-8">
              ...
              >
                ...
                <div className="pt-12">
                  ...
                  <p className="text-gray-600 text-lg">
                    중요한 순간마다 당신의 선택이 이야기의 방향을 결정합니다.
                  </p>
                </div>
              </motion.div>
            </div>
