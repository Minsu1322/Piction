...
export default function Header() {
  ...
  return (
    <header className="w-full py-4 px-6 flex justify-between items-center bg-transparent shadow-md">
      ...
      {/* 네비게이션 탭 */}
      <nav className="flex items-center text-xl font-medium text-black ml-auto mr-8">
        <Link
          ...
          <div className="relative">
            <button onClick={() => setIsDropdownOpen((prev) => !prev)}>
              {user?.user_metadata?.avatar_url ? (
                ...
                <div className="w-10 h-10 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center text-black font-medium cursor-pointer">
